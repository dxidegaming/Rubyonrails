...
class ForumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum" do
    assert_difference('Forum.count') do
      post forums_url, params: { forum: { User_id: @forum.User_id, content: @forum.content, subject: @forum.subject } }
    end
  ...
  test "should update forum" do
    patch forum_url(@forum), params: { forum: { User_id: @forum.User_id, content: @forum.content, subject: @forum.subject } }
